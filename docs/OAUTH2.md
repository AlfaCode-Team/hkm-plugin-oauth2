...
> by [Auth plugin](https://github.com/AlfaCode-Team/hkm-plugin-auth/blob/main/docs/AUTH.md)'s `JwtAuthLayer` with no extra wiring. Pairs with
> [User plugin](https://github.com/AlfaCode-Team/hkm-plugin-user/blob/main/docs/USER.md) (password grant), [Kernel security](https://github.com/AlfaCode-Team/hkm-kernel/blob/main/docs/guides/09_SECURITY.md).
